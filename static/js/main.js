document.addEventListener('DOMContentLoaded', () => {
    ...
    const dict = {
        tr: {
            welcomeTitle: "GHOST INTERFACE",
            welcomeDesc: "Lütfen sisteme yüklemek veya görüntülemek için bir dosya seçin.",
            guideBtn: "Rehberi Görüntüle",
            startBtn: "Sistemi Başlat",
            resetBtn: "GERİ DÖN",
            chooseFile: "Dosya Seç",
            guideTitle: "Sistem Rehberi",
            closeGuideBtn: "Kapat",
            filesTitle: "Dosyalar",
            docTitle: "Döküman",
            streamTitle: "Canlı Akış",
            gestureTitle: "Son Jest",
            waiting: "SİNYAL BEKLENİYOR...",
            logsTitle: "Loglar",
            logInit: "Sistem başlatıldı.",
            logFileSelected: "Dosya seçildi: ",
            logSystemStarted: "Sistem başlatıldı.",
            logSystemClosed: "Sistem kapatıldı.",
            latency: "GECİKME:",
            fps: "FPS:",
            sysActive: "AKTİF",
            langBtn: "EN",
            viewing: "GÖRÜNTÜLENİYOR"
        },
        en: {
            welcomeTitle: "GHOST INTERFACE",
            welcomeDesc: "Please select a file to upload or view in the system.",
            guideBtn: "View Guide",
            startBtn: "Start System",
            resetBtn: "GO BACK",
            ...
            gestureTitle: "Last Gesture",
            waiting: "WAITING FOR SIGNAL...",
            logsTitle: "Logs",
            logInit: "System initialized.",
            logFileSelected: "File selected: ",
            logSystemStarted: "System started.",
            logSystemClosed: "System shut down.",
            latency: "LATENCY:",
            fps: "FPS:",
            sysActive: "ACTIVE",
            langBtn: "TR",
    ...
    window.triggerGestureFeedback = function (gestureName) {
        ...
        gestureTextSpan.innerText = gestureName;
        addSystemLog(`Jest: ${gestureName}`);
        
        // Add subtle glow just to the edges of the document viewer
    ...
    setInterval(() => {
        const latencyEl = document.getElementById('chip-latency');
        const fpsEl = document.getElementById('chip-fps');
        if (latencyEl && fpsEl) {
            latencyEl.innerText = Math.floor(Math.random() * 21 + 35) + "ms";
            fpsEl.innerText = Math.floor(Math.random() * 3 + 59);
        }
    }, 1500);

    updateLanguage();

    /* ── Particle field animation for welcome screen ── */
    (function initParticles() {
        ...
        function tick() {
            /* Only run when welcome screen is visible */
